...
namespace WebApi.Helper
{
    ...
    {
        protected bool _IsBanSi
        {
            get
            {
                var IsBanSi = false;
                var v_identity = (ClaimsIdentity)User.Identity;
                if (v_identity != null)
                {
                    var vRole = v_identity.Claims.FirstOrDefault(c => c.Type == ClaimTypes.Role);
                    if (vRole != null && vRole.Value == CMaRole.BanSi)
                    {
                        IsBanSi = true;
                    }
                }
        ...
        protected Guid _UserId
        {
            get
            {
                ...
                if (v_identity != null)
                {
                    var userid = v_identity.Claims.FirstOrDefault(c => c.Type == "UserId");
                    if (userid != null)
                    {
