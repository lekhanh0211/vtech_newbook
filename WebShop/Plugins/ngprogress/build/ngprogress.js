        ...
        this.$get = ['$document',
            ...
            '$timeout', function ($document, $window, $compile, $rootScope, $timeout) {
                ...
                return {
                    ...
                    // to hide it
                    start: function (isBlockUI = false) {
                    ...
                    complete: function (isBlockUI = false) {
                        count = 100;
                        this.updateCount(count);
                        var self = this;
                        clearInterval(intervalCounterId);
...
angular.module('ngProgress.directive', [])
    .directive('ngProgress', ["$window", "$rootScope", function ($window, $rootScope) {
        var directiveObj = {
            ...
            template: '<div id="ngProgress-container"><div id="ngProgress"><div class="spinner-icon"></div></div></div>'
        };
        return directiveObj;
    }]);
