...
{
    [RoutePrefix("api/DMDoiTac")]
    public class DMDoiTacController : BaseApiController<DMDoiTacManager, DMDoiTacModel>
    {
        [Route("")]
        [HttpGet]
        ...
        [Route("")]
        [HttpPost]
        public override HttpResponseMessage Post(DMDoiTacModel value)
        {
